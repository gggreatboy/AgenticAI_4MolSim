...
- Alternative only install Ollama
```bash 
    ./install_ollama.sh
```
...
Once the tools are defined, we make use of LangChain to generate Agent executor functions which allow us to call the functions throught LLMs. The general workflow, or template is based on DynaMate, and additional details can be found here. REF: https://pubs.rsc.org/en/content/articlehtml/2025/me/d5me00062a
